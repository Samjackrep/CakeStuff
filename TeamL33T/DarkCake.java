...
public class DarkCake extends Block
{
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("cakestuff:darkcake_side");
        this.field_94382_c = par1IconRegister.registerIcon("cakestuff:darkcake_inner");
        this.cakeTopIcon = par1IconRegister.registerIcon("cakestuff:darkcake_top");
        this.cakeBottomIcon = par1IconRegister.registerIcon("cakestuff:darkcake_bottom");
    }
